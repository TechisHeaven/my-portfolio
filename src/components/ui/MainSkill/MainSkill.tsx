...
export default async function MainSkill() {
  return (
    <div className="py-20 my-20 mt-40">
      <div className="text-center mainSkillheading">
      ...
      <div className="skills flex items-center gap-4 justify-center my-10">
        <div className="skill shadow hover:shadow-md transition-all p-8 flex items-center gap-2 flex-col rounded-md px-12 border relative select-none">
          <Layers3 />
